        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          <motion.div variants={fadeInUp} className="space-y-8 text-lg text-text leading-relaxed">
            ...
            <div className="grid gap-4 pt-4 sm:grid-cols-2">
              <div className="rounded-[24px] border border-line/70 bg-bg-elev-1/80 px-5 py-4 shadow-card">
          ...
          <motion.div variants={fadeInUp}>
            <div className="relative rounded-[28px] border border-line/70 bg-bg-elev-1/80 p-8 shadow-card">

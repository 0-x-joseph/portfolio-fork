...
import { ArrowRight, Cpu, MapPin, Shield, Sparkles, Coins, Zap } from 'lucide-react';
    ...
    >
        ...
        <div>
          <motion.div variants={fadeInUp} className="mb-8 flex flex-wrap items-center gap-4 text-[11px] font-mono uppercase tracking-[0.3em] text-text-muted">
            <span className="inline-flex items-center gap-2 rounded-full border border-line-strong/70 bg-bg-elev-1/80 px-4 py-2 text-text-strong">
              ...
              Ready for Protocol Research
            </span>
            <span className="h-px w-10 bg-line/70" />
            <span className="flex items-center gap-2">
              <Zap size={12} className="text-accent" /> Backend & Blockchain Engineer
            </span>
          </motion.div>
          ...
          <motion.div variants={fadeInUp} className="mt-8 max-w-2xl space-y-6 text-lg text-text md:text-xl">
            <p className="leading-relaxed">
              I architect <span className="text-text-strong">decentralized infrastructure</span> and low-level systems. 
              By merging quantitative finance insights with rigorous systems engineering from 1337, 
              I build secure, high-performance protocols for the future of finance.
            </p>
            <div className="flex flex-wrap gap-3 text-[11px] font-mono uppercase tracking-[0.3em] text-text-muted">
              <span className="rounded-full border border-line/70 bg-bg-elev-1/80 px-4 py-2">Protocol Design</span>
              <span className="rounded-full border border-line/70 bg-bg-elev-1/80 px-4 py-2">Applied Cryptography</span>
              <span className="rounded-full border border-line/70 bg-bg-elev-1/80 px-4 py-2">Distributed Systems</span>
            </div>
          </motion.div>

          <motion.div variants={fadeInUp} className="mt-10 flex flex-wrap gap-5">
            <ButtonGlitch href="#experience" primary>
              View Proof of Work
            </ButtonGlitch>
            <ButtonGlitch href={SOCIALS.resume} download="Youssef_Bouryal_CV.pdf">
              Download Specs
            </ButtonGlitch>
          </motion.div>
        </div>
        ...
        <motion.div variants={fadeInUp} style={{ y: reduceMotion ? 0 : y, opacity: reduceMotion ? 1 : opacity }} className="grid gap-6">
          <div className="rounded-[28px] border border-white/10 bg-bg-elev-1/70 p-6 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.04)_inset] backdrop-blur transition-all duration-500">
            <div className="flex items-center justify-between text-[11px] font-mono uppercase tracking-[0.3em] text-text-muted">
              ...
              <span className="text-text-strong">Core Node</span>
            </div>
            <div className="mt-6 grid gap-3 text-sm text-text">
              <div className="flex items-start gap-3 rounded-2xl border border-white/10 bg-bg/60 px-4 py-3 backdrop-blur-sm transition-colors">
                ...
                <div>
                  <div className="text-text-strong">Distributed Infrastructure</div>
                  <div className="text-xs text-text-muted">P2P, Consensus, Mempool Optimization</div>
                </div>
              </div>
              <div className="flex items-start gap-3 rounded-2xl border border-white/10 bg-bg/60 px-4 py-3 backdrop-blur-sm transition-colors">
                <Shield size={16} className="mt-1 text-accent-2" />
                <div>
                  <div className="text-text-strong">Cryptographic Integrity</div>
                  <div className="text-xs text-text-muted">ECDSA, Signature Recovery, Auth</div>
                </div>
              </div>
              <div className="flex items-start gap-3 rounded-2xl border border-white/10 bg-bg/60 px-4 py-3 backdrop-blur-sm transition-colors">
                <Coins size={16} className="mt-1 text-accent-3" />
                <div>
                  <div className="text-text-strong">Quantitative Logic</div>
                  <div className="text-xs text-text-muted">Tokenomics & Algorithmic Finance</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-[28px] border border-white/10 bg-bg-elev-2/70 p-6 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.04)_inset] backdrop-blur transition-all duration-500">
            <div className="flex items-center justify-between text-[11px] font-mono uppercase tracking-[0.3em] text-text-muted">
              ...
              <span className="text-text-strong">Morocco</span>
            </div>
            <div className="mt-6 flex items-center justify-between rounded-2xl border border-white/10 bg-bg/60 px-4 py-4 text-sm text-text backdrop-blur-sm transition-colors">
              <div className="flex items-center gap-3">
                ...
                <span>Rabat / Remote Friendly</span>
              </div>
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <span className="h-px w-10 bg-line/70" />
          <span>Proof of Work + Protocols</span>
        </div>
        <div>Engineered for the Decentralized Web</div>
      </motion.div>
    </section>
  );
};
